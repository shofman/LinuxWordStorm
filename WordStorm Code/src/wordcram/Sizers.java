 ...
 * @see WordSizer
 */
public class Sizers implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 939933302292417521L;
	 ...
	 * 
	 * <pre>
	 * MyPApplet.lerp(minSize, maxSize, (float) word.weight)
	 * </pre>
	 * 
	 * @param minSize
	...
	public static WordSizer byWeight(final int minSize, final int maxSize) {
		return new WordSizer() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8641876354116564855L;

			public float sizeFor(Word word, int wordRank, int wordCount) {
				return MyPApplet.lerp(minSize, maxSize, word.weight);
	 ...
	 * 
	 * <pre>
	 * MyPApplet.map(wordRank, 0, wordCount, maxSize, minSize)
	 * </pre>
	 * 
	 * @param minSize
	...
	public static WordSizer byRank(final int minSize, final int maxSize) {
		return new WordSizer() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6593047917130612955L;

			public float sizeFor(Word word, int wordRank, int wordCount) {
				return MyPApplet.map(wordRank, 0, wordCount, maxSize, minSize);
			}
		};
	}
