...
public class FileLoaderWeight extends Loader implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4736287130654665336L;
	...
	public void loadText(MyPApplet parent, WordCram w, int index){	
		String source = join(parent.loadStrings(inPath+"/"+fileNames[index]), ';');		
	...
	private String join(String[] list, char separator) {
		    return join(list, String.valueOf(separator));
		  }


	private String join(String[] list, String separator) {
