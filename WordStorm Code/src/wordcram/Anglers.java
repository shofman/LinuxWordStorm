 ...
 * @author Dan Bernier
 */
public class Anglers implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6727474844435216178L;
	...
	public static WordAngler random(long rSeed) {
		...
		return new WordAngler() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 8178660113621095112L;
	...
	public static WordAngler randomBetween(long rSeed, final float min, final float max) {
		...
		return new WordAngler() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 7078748805622385345L;
	...
	public static WordAngler heaped(long rSeed) {
		...
		final float  angle = 7 * DEG_TO_RAD;
	...
	public static WordAngler alwaysUse(final float angle) {
		return new WordAngler() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6203015862189592003L;
	...
	public static WordAngler pickFrom(long rSeed, final float... angles) {
		...
		return new WordAngler() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -596533874557457274L;
